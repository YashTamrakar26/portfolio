...
export default function Contact () {
    ...
    const sendEmail = (e: React.FormEvent<HTMLFormElement>): void => {
        ...
        emailjs
            ...
            .then(
                () => {
                    let curr = form.current as HTMLFormElement;
                    setSuccess(true);
                    curr.reset();
                },
                () => {
        ...
        >
            <div className="h-[80vh] flex flex-col lg:flex-row px-4 sm:px-8 md:px-12 lg:px-20 xl:px-48 mt-[1%] mb-[5%]">
                ...
                <form
                    onSubmit={sendEmail}
                    ref={form}
                    className="h-[80%] lg:h-full lg:w-1/2 bg-red-50 rounded-xl text-xl flex flex-col gap-8 justify-center p-12"
                >
                    <span>Hi Yash Tamrakar,</span>
                    <textarea
                        rows={6}
